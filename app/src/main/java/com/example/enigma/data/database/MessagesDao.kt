...
interface MessagesDao {
    ...
    @Query("INSERT INTO $MESSAGES_TABLE(chatId, text, incoming, date, sent, id)" +
            "VALUES(:chatId, :text, :incoming, :date, :sent, " +
    ...
    suspend fun insert(chatId: String, text: String, incoming: Boolean, sent: Boolean, date: Date): Long
